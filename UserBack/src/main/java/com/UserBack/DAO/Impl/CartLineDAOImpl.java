...
public class CartLineDAOImpl implements CartLineDAO {
	...
	public Cart getByMobile(String mobile) {
		String query="from Cart where user_mobile=:mobile";
		return sessionFactory.getCurrentSession().createQuery(query,Cart.class).setParameter("mobile", mobile).getSingleResult();
	}
